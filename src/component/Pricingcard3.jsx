    ...
    >
      <div className="p-8 text-center border-b border-white/10">
        ...
        <div className="mb-4">
          ...
          <span className="text-4xl font-bold text-green-400">79</span>
          <span className="text-sm text-gray-400">/month</span>
        </div>
        <p className="text-sm text-gray-400">For large companies and organisations</p>
      </div>
      ...
      <div className="p-8">
        <ul className="space-y-4 text-sm">
          ...
          <li className="flex items-center">
            <FaCheck className="text-green-400 mr-2" /> Custom Domain
          </li>
        </ul>
      </div>
